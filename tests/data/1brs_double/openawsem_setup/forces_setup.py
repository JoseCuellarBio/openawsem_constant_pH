...
def set_up_forces(oa, computeQ=False, submode=-1, contactParameterLocation=".", membrane_center=-0*angstrom):
    # apply forces
    forces = [
        basicTerms.con_term(oa, forceGroup=0),
        basicTerms.chain_term(oa, forceGroup=1),
        basicTerms.chi_term(oa, forceGroup=2),
        basicTerms.excl_term(oa, forceGroup=3),
        basicTerms.rama_term(oa, forceGroup=4),
        basicTerms.rama_proline_term(oa, forceGroup=5),
        basicTerms.rama_ssweight_term(oa, k_rama_ssweight=2*8.368, forceGroup=6),
